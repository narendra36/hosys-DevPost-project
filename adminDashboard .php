...
<body onload="CaptchaChange()">
	...
	<div class="btn">
		<div class="adminbutton" ><a href="#" target="_blank" ><p style="color:white">ADD DOCTOR</p></a></div> 
		<div class="adminbutton"><a href="doctorList.php" target="_blank" ><p style="color:white">List of Doctors</p></a></div>
		<div class="adminbutton" ><a href="patientList.php" target="_blank" ><p style="color:white">List of Patient</p></a></div>
